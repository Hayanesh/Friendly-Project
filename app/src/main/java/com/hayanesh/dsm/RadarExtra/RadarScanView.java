package com.hayanesh.dsm.RadarExtra;
...
public class RadarScanView extends View
{
    ...
    private int circleColor = Color.parseColor("#4dc2ff");
    private int radarColor = Color.parseColor("#54ffffff");
    private int tailColor = Color.parseColor("#4dc2ff");
